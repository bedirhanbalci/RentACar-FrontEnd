...
import './AdditionalFeatureSlider.css';
...
interface AdditionalFeatureSliderProps {
  cards: Card[];
}

const AdditionalFeatureSlider: React.FC<AdditionalFeatureSliderProps> = ({ cards }) => {
...
export default AdditionalFeatureSlider;
